...
function GerenciarDespesa() {
  ...
  const handleChangeValor = (text) => {
    ...
    // Regex: apenas números com até 2 casas decimais
...
const styles = StyleSheet.create({
  ...
  input: {
    ...
    padding: 8,
    borderRadius: 4,
    justifyContent: 'center', // Para o texto do Pressable ficar centralizado verticalmente
    minHeight: 40,
  },
});